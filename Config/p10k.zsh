# Generated by Powerlevel10k configuration wizard on 2022-10-22 at 17:48 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 32663.
# Wizard options: nerdfont-complete + powerline, small icons, classic, unicode, darkest,
# 24h time, slanted separators, sharp heads, sharp tails, 2 lines, disconnected,
...
rbenv                   # ruby version from rbenv (https://github.com/rbenv/rbenv)
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' #Fedora
