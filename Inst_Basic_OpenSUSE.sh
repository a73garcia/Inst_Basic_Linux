...
echo -e "\033[33mConfiguración inicial del terminal e instalación de paquetes básicos en SO basados en \033[1m\033[4m\033[32mOpenSUSE\033[0m\033[0m"
...
echo -e "\033[31mInstalando base-devel...\033[0m"
sudo zypper install -y gcc make autoconf automake git

# Instalar paquetes necesarios
echo -e "\033[31mInstalando paquetes...\033[0m"
sudo zypper install -y git wget kate feh p7zip mlocate yay lsd bat net-tools neovim gparted curl fastfetch kitty dolphin gimp inkscape hexchat qbittorrent putty thunderbird keepassxc texlive texmaker powerline-fonts zsh vscode yt-dlp gdisk testdisk

# Instalar Media Writer (usando el código fuente de AUR)
...
\033[1m\033[4m\033[33mInstalación finalizada correctamente\033[0m

\033[1m\033[32mResumen de la instalación:\033[0m
...
- Se ha descargado y configurado las fuentes Meslo
- Se han copiado configuraciones personalizadas zshrc y p10k
